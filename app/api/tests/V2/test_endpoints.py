...
class TestEndpoints(unittest.TestCase):
    ...
    def test_get_all_orders(self):
        ...
        with self.app.test_request_context():
            self.client.post(
                "/api/v2/menu", json={'foodname': 'Pizza', 'price': '$4.99'})
    ...
    def test_get_specific_order(self):
        with self.app.test_request_context():
            ...
            res = self.client.get("/api/v2/orders/0")
    ...
    def test_modifying_status(self):
        with self.app.test_request_context():
            ...
            self.client.post("/api/v2/orders",
                             json={'foodname': 'Pizza', 'price': '$6.99'})
            self.client.put("/api/v2/orders/1", json={'status': 'accepted'})
            res = self.client.get("/api/v2/orders/1")
            self.assertIn("accepted", res.get_data(as_text=True))

            res = self.client.put("/api/v2/orders/0",
    ...
    def test_adding_meal_to_menu(self):
        ...
        with self.app.test_request_context():
            ...
            self.client.post(
                "/api/v2/menu", json={'foodname': 'Burger', 'price': '$4.99'})
            res = self.client.get("/api/v1/menu")
            order = res.get_json()
            for item in order.values():
                orders = item
    ...
    def test_get_menu(self):
        ...
        res = self.client.post(
            "/api/v2/menu", json={'foodname': 'Baggels', 'price': '$4.99'})
        self.assertEqual(201, res.status_code)
        res = self.client.get("/api/v1/menu")
        self.assertEqual(200, res.status_code)
    ...
    def test_for_order(self):
        with self.app.test_request_context():
            self.client.post(
                "/api/v2/menu", json={'foodname': 'Pizza', 'price': '$4.99'})
            self.client.post(
                "/api/v2/menu", json={'foodname': 'Burger', 'price': '$7.99'})

            self.client.post("/api/v2/users/orders", json={'foodname': 'Pizza'})
            res = self.client.get("/api/v2/orders")
            order = res.get_json()
            for item in order.values():
                orders = item
            ...
            self.client.post("/api/v2/users/orders", json={'foodname': 'Burger'})
            res = self.client.get("/api/v2/menu")
            order = res.get_json()
            for item in order.values():
                orders = item
            ...
            res = self.client.post(
                "/api/v2/users/orders", json={'foodname': 'Hot dog'})
            self.assertEqual(
